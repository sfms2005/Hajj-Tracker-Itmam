      ...
      >
        <defs>
          <linearGradient id="goldPath" x1="0" y1="0" x2="1" y2="0">
            ...
            <stop offset="50%" stopColor="#e6c96a" />
...
function HereIndicator({ side }: { side: "left" | "right" }) {
  ...
  return (
    ...
    >
      <span className="block whitespace-nowrap rounded-lg bg-[#1f1f1d] px-3 py-1 text-[12px] font-bold text-[#e6c96a] shadow-[0_6px_18px_rgba(31,31,29,0.35)] ring-1 ring-[#d1ae37]/40">
        أنت هنا
      </span>
      <svg
        width="52"
        ...
        aria-hidden="true"
      >
        <g stroke="#d1ae37" strokeWidth="2" strokeLinecap="round" fill="none">
          {isRight ? (
            <>
