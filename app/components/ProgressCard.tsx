...
export default function ProgressCard({ percentage }: Props) {
  ...
  return (
    <div className="rounded-2xl border border-[#c9a04a]/15 bg-white px-4 py-3 shadow-[0_8px_24px_rgba(139,96,24,0.08),0_1px_3px_rgba(0,0,0,0.04)]">
      <div className="flex items-center gap-2.5">
        ...
        <span className="min-w-11 text-left text-sm font-extrabold text-[#6b4a14]">
          %{safePercent}
        </span>
      </div>
    </div>
