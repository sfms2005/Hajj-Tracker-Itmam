  ...
  return (
    <>
      <nav className="flex items-center justify-between px-5 pt-0 pb-0">
        ...
        >
          <Image
            src="/Alsalam-Gold.png"
            alt="حملة قاصد"
            width={384}
            height={483}
            priority
            className="h-20 w-auto drop-shadow-[0_4px_12px_rgba(201,160,74,0.35)]"
          />
        </Link>
        ...
        <button
          ...
          className="flex h-10 w-10 flex-col items-center justify-center gap-[5px] rounded-md transition-colors hover:bg-[#6b4a14]/5 active:bg-[#6b4a14]/10"
        >
          <span className="block h-[2.5px] w-6 rounded-full bg-[#6b4a14]" />
          <span className="block h-[2.5px] w-6 rounded-full bg-[#6b4a14]" />
          <span className="block h-[2.5px] w-6 rounded-full bg-[#6b4a14]" />
        </button>
      </nav>
      ...
      <aside
        ...
        className={`fixed top-0 left-0 z-50 h-full w-[72%] max-w-xs bg-[linear-gradient(135deg,#6b4a14,#8b6018)] text-white shadow-[0_0_40px_rgba(0,0,0,0.25)] transition-transform duration-300 ease-out ${
