...
export default function MotivationCard({ message }: Props) {
  return (
    <div className="flex items-center gap-2 rounded-2xl border border-[#c9a04a]/15 bg-white px-4 py-3 shadow-[0_8px_24px_rgba(139,96,24,0.08),0_1px_3px_rgba(0,0,0,0.04)]">
      <span className="flex h-8 w-8 shrink-0 items-center justify-center">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          className="h-7 w-7 drop-shadow-[0_2px_4px_rgba(201,160,74,0.35)]"
          aria-hidden="true"
        >
          <defs>
            <linearGradient
            ...
            >
              ...
              <stop offset="50%" stopColor="#e8cc7e" />
